...
class HTMLFormsTools {
	...
	**/
	...
	private function generateFormHeader($arrayConfig) {
		...
		// Form Icon
        $action = '';
		if(array_key_exists('action', $arrayConfig)) $action = $arrayConfig['action'];
		...
		$strHTML.= "\n".'<form action="'.$action.'" class="ui form" method="POST" name="'.$strformname.'" onsubmit="'.$strformonsubmitaction.'">';
